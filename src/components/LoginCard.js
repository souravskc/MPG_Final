            ...
            return(
                ...
                values={[
                    ...
                    <TabItem value='login'>
                        ...
                        <Button type="submit" variant="primary" className="bg-blue-600 text-white p-2 px-4 rounded-md hover:bg-blue-700 border-none " onClick={() => {setShow(true);onSubmit()}}><div className="text-lg">Submit</div></Button>
