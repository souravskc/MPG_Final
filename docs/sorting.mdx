...
<ResourceQuestion resource = "true" list={[{name:"Binary Search codeforces lessons",link:"https://codeforces.com/edu/course/2/lesson/6"},{name:"Binary Search topcoder article",link:"https://www.topcoder.com/community/competitive-programming/tutorials/binary-search/"},]}/>
