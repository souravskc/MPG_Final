...
<TabItem value="resource">
	<Question resource = "true" list={[{name:"Code Forces",link:"https://codeforces.com/edu/course/2/lesson/6"},]}/>
</TabItem>

:::important
The main theorem in this topcoder article is a gem that is hard to find, read it and own it

<Card title="Binary Search"  url="https://www.topcoder.com/community/competitive-programming/tutorials/binary-search/" />
:::
