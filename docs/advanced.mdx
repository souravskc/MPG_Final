...
<ResourceQuestion resource = "true" list={[{name:"Understanding Range Minimum Query",link:"https://cp-algorithms.com/sequences/rmq.html"},]}/>
...
<ResourceQuestion resource = "true" list={[{name:"Bit Masking Hackerearth Tutorial",link:"https://www.hackerearth.com/practice/algorithms/dynamic-programming/bit-masking/tutorial"},{name:"DP With Bitmask CodeForces Blog",link:"https://codeforces.com/blog/entry/337"},]}/>
...
<ResourceQuestion resource = "true" list={[{name:"Digit Dp CodeForces Blog",link:"https://codeforces.com/blog/entry/53960"},{name:"Digit Dp Code Resource",link:"https://github.com/flash7even/Programming-Contest/blob/master/Code%20Repository/Dynamic%20Programming/Digit%20DP/Digit-DP.cpp"},{name:"",link:"http://gautamdegitdp.blogspot.com"},]}/>
...
<ResourceQuestion resource = "true" list={[{name:"In-Out Dp Explained",link:"https://www.youtube.com/watch?v=Xng1Od_v6Ug"},{name:"InOut Dp On Trees",link:"https://blogarithms.github.io/articles/2019-10/inout-dp-tree"},{name:"In-Out Dp CodeForces Blog",link:"https://codeforces.com/blog/entry/20935"},{name:"Dynamic Programming On Trees",link:"https://www.geeksforgeeks.org/dynamic-programming-trees-set-2/"},]}/>
...
<ResourceQuestion resource = "true" list={[{name:"Sparse Table HackerEarth Tutorial",link:"https://www.hackerearth.com/practice/notes/sparse-table/"},{name:"Sparse Table Cp Algo",link:"https://cp-algorithms.com/data_structures/sparse-table.html"},]}/>
...
<ResourceQuestion resource = "true" list={[{name:"Segment Tree And Lazy Propagation Hackerearth Tutorial",link:"https://www.hackerearth.com/practice/notes/segment-tree-and-lazy-propagation/"},{name:"Understanding Range Queries And Updates Segment Tree Lazy Propagation",link:"https://medium.com/nybles/understanding-range-queries-and-updates-segment-tree-lazy-propagation-and-mos-algorithm-d2cd2f6586d8/"},]}/>
...
<ResourceQuestion resource = "true" list={[{name:"Simplifying Square Root Decomposition",link:"https://blogarithms.github.io/articles/2019-07/square-root-decomposition"},{name:"Sqrt Decomposition Cp Algo",link:"https://cp-algorithms.com/data_structures/sqrt_decomposition.html"},{name:"Sqrt Decomposition Codeforces Blog",link:"https://codeforces.com/blog/entry/83248"},]}/>
...
<ResourceQuestion resource = "true" list={[{name:"Suffix Array Hackerearth Tutorial",link:"https://www.hackerearth.com/practice/data-structures/advanced-data-structures/suffix-arrays/tutorial"},{name:"Suffix Array Cp Algo",link:"https://cp-algorithms.com/string/suffix-array.html"},{name:"Suffix Array Codeforces tutorial",link:"https://codeforces.com/edu/course/2"},{name:"A Tutorial On Suffix Arrays",link:"https://discuss.codechef.com/t/a-tutorial-on-suffix-arrays/2950"},{name:"Suffix Array Introduction",link:"https://www.geeksforgeeks.org/suffix-array-set-1-introduction/"},]}/>
...
<ResourceQuestion resource = "true" list={[{name:"Suffix Tree Hackerearth Tutorial",link:"https://www.hackerearth.com/practice/data-structures/advanced-data-structures/suffix-trees/tutorial"},{name:"Suffix Tree Cp Algo",link:"https://cp-algorithms.com/string/suffix-tree-ukkonen.html"},]}/>
...
<ResourceQuestion resource = "true" list={[{name:"Edge Vertex Connectivity Cp Algo",link:"https://cp-algorithms.com/graph/edge_vertex_connectivity.html"},]}/>
