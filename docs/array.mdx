...
<TabItem value="resource">
	<Question resource = "true" list={[{name:"How Arrays Are Passed To Functions In Cc",link:"https://www.geeksforgeeks.org/how-arrays-are-passed-to-functions-in-cc/"},{name:"Pass 2D Array Function Parameter Cpp",link:"https://www.techiedelight.com/pass-2d-array-function-parameter-cpp/"},]}/>
</TabItem>
