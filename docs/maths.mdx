...
<Tabs
  ...
  values={[
    ...
    <TabItem value="easy">
      <Question  list={[{ name:'SoloLearn OP',link:'https://sololearn.com/',desc:'Lorem ipsum dolor sit amet, consectetur adipiscing elit labore et dolore magna aliqua.'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'}]}/>
    </TabItem>
  
    <TabItem value="medium">
        <Question resource='true' list={[{ name:'SoloLearn OP',link:'https://sololearn.com/',desc:'Lorem ipsum dolor sit amet, consectetur adipiscing elit labore et dolore magna aliqua.'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'}]}/>
    </TabItem>
    <TabItem value="hard"><Question  list={[{ name:'SoloLearn OP',link:'https://sololearn.com/',desc:'Lorem ipsum dolor sit amet, consectetur adipiscing elit labore et dolore magna aliqua.'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'}]}/>
</TabItem>
</Tabs>


<Card title="TC (Amortised, Average, Best, Worst)" url="https://www.basicsbehind.com/2016/12/18/analysis-of-algorithms/" />
<Question  list={[{ name:'SoloLearn OP',link:'https://sololearn.com/',desc:'Lorem ipsum dolor sit amet, consectetur adipiscing elit labore et dolore magna aliqua.'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'}]}/>
<Question resource="true" list={[{ name:'hello there there there there',link:'https://sololearn.com/',desc:'there there there there there there there therethere there there therethere therethere therethere there'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'}]} />

<!-- [Link](https://www.basicsbehind.com/2016/12/18/analysis-of-algorithms/) -->
