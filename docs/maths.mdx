...
<Tabs
  ...
  <TabItem value="medium">
      <Question resource="true" list={[{ name:'Link 1 here',link:'https://sololearn.com/',desc:'Question on topic 1 with some description random stuff here'},{ name:'general',link:'https://sololearn.com/',desc:'kenobi'}]} />
